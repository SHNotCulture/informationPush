...
import com.eparking.informationPush.entity.system.ParkInOutCacheCriteria.Criteria;
import com.eparking.informationPush.entity.system.ParkInOutCacheCriteria.Criterion;
import com.eparking.informationPush.entity.system.ParkInOutCacheCriteria;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ParkInOutCacheSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(ParkInOutCacheCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("park_in_out_cache");
     ...
     * @mbg.generated
     */
    public String deleteByExample(ParkInOutCacheCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("park_in_out_cache");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(ParkInOutCache record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("park_in_out_cache");
     ...
     * @mbg.generated
     */
    public String selectByExample(ParkInOutCacheCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ParkInOutCache record = (ParkInOutCache) parameter.get("record");
        ParkInOutCacheCriteria example = (ParkInOutCacheCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("park_in_out_cache");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(ParkInOutCache record) {
        SQL sql = new SQL();
        sql.UPDATE("park_in_out_cache");
        ...
        if (record.getRouteId() != null) {
            sql.SET("route_id = #{routeId,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, ParkInOutCacheCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
