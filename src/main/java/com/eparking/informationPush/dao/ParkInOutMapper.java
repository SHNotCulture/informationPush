...
import com.eparking.informationPush.dao.sqlProvider.ParkInOutSqlProvider;
...
public interface ParkInOutMapper {
    /**
     ...
     * @mbg.generated
     */
    @SelectProvider(type= ParkInOutSqlProvider.class, method="countByExample")
    long countByExample(ParkInOutCriteria example);
     ...
     * @mbg.generated
     */
    @DeleteProvider(type=ParkInOutSqlProvider.class, method="deleteByExample")
    int deleteByExample(ParkInOutCriteria example);
     ...
     */
    @Insert({
        "insert into park_in_out (id, actual_pay, ",
        "before_pay, car_nature, ",
        "charge_type, coupon, ",
        "e_pay_type, gov_in_up_flag, ",
        "gov_out_up_flag, in_car_plate, ",
        ...
        "#{govOutUpFlag,jdbcType=INTEGER}, #{inCarPlate,jdbcType=VARCHAR}, ",
        ...
        "#{qpassPay,jdbcType=DOUBLE})"
    })
    int insert(ParkInOut record);
     ...
     * @mbg.generated
     */
    @InsertProvider(type=ParkInOutSqlProvider.class, method="insertSelective")
    int insertSelective(ParkInOut record);
     ...
     * @mbg.generated
     */
    @SelectProvider(type=ParkInOutSqlProvider.class, method="selectByExample")
    @Results({
    ...
    List<ParkInOut> selectByExample(ParkInOutCriteria example);
    ...
    @Select({
        "select",
        "id, actual_pay, before_pay, car_nature, charge_type, coupon, e_pay_type, gov_in_up_flag, ",
        "gov_out_up_flag, in_car_plate, in_car_plate_color, in_pic_path, in_port_id, ",
        "in_port_name, in_time, need_pay, occur_time, order_id, out_car_plate, out_car_plate_color, ",
        "out_pic_path, out_port_id, out_port_name, out_time, out_type, park_id, qpass_pay",
        "from park_in_out",
        "where id = #{id,jdbcType=VARCHAR}"
    })
    @Results({
    ...
    ParkInOut selectByPrimaryKey(String id);
     ...
     * @mbg.generated
     */
    @UpdateProvider(type=ParkInOutSqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") ParkInOut record, @Param("example") ParkInOutCriteria example);
     ...
     * @mbg.generated
     */
    @UpdateProvider(type=ParkInOutSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") ParkInOut record, @Param("example") ParkInOutCriteria example);
     ...
     * @mbg.generated
     */
    @UpdateProvider(type=ParkInOutSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(ParkInOut record);
    ...
    int updateByPrimaryKey(ParkInOut record);
}